...
export default{
    ...
    description: 'IShowSpeed divides numbers (integers)',
    slash: 'both',
    options:
    [
        {
            name: 'first_number',
            description: 'This is the first number being divided',
            type: 'NUMBER',
            required: true
        },
        {
            name: 'second_number',
            description: 'This is the second number being divided',
            type: 'NUMBER',
            required: true
        }
    ],
    ...
    callback:({message, interaction})=>{
        ...
        return `IShowSpeed divided ${number1} and ${number2} and got ${number1/number2}`
    }
} as ICommand